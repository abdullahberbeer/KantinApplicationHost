...
import { CheckoutDto } from '../_dto/checkoutDto.model';
...
export class BasketService {
  ...
  checkout(CheckoutDto:CheckoutDto):Observable<any>{
return this.http.post(this.baseUrl+'/Basket/checkout',CheckoutDto,{responseType: 'text'});
  }
}
