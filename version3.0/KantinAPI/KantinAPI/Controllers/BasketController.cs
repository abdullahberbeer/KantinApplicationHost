...
namespace KantinAPI.Controllers
{
    ...
    public class BasketController : Controller
    {
        ...
        public IActionResult Checkout(Checkout entity)
        {

            try
            {
                var basket = _basketService.GetByPersonId(entity.PersonId);
                ...
                modell.BasketItems = new List<BasketItem>();


                foreach (var item in basket.Result.BasketItems)
                {
                    ...
                    modell.BasketItems.Add(basketItem);
                }
