    ...
    public class BasketManager : IBasketService
    {
        ...
        public async Task<bool> AddToCart(AddBasketItemDto entity)
        {
            ...
            if (cart != null)
            {
                ...
                product.Stock -= entity.Adet;

                if (product.Stock >= 0)
                {
                   await _productRepositroy.Update(product);
            ...
            
        {
            ...
            var product = _productRepositroy.GetById(entity.productId);

            product.Result.Stock += entity.adet;
            

          await _productRepositroy.Update(product.Result);
